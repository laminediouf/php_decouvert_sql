...
$reponse=$bdd->query("SELECT COUNT(gender) AS nbrHomme FROM table1 WHERE gender='Male'") or die(print_r($bdd->errorInfo()));
$reponse2=$bdd->query("SELECT COUNT(gender) AS nbrFemme FROM table1 WHERE gender='Female'") or die(print_r($bdd->errorInfo()));
?>
<!doctype html>
<html lang="fr">
<head>
