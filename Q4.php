...
$reponse=$bdd->query("SELECT * FROM table1 WHERE email like '%google%'") or die(print_r($bdd->errorInfo()));
?>
<!doctype html>
<html lang="fr">
<head>
            ...
            <div class="panel panel-primary">
                <table class="table table-striped table-condensed">
                    <div class="panel-heading">
                        <h3 class="panel-title">Affichage des Emails qui Contient Google</h3>
                    </div>
                    <thead>
                    <tr>
                        <th>Id</th>
